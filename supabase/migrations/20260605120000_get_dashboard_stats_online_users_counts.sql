-- Developer dashboard presence metrics from online_users (UTC server time).
-- users_online_now: last_seen within 2 minutes
-- active_users_today: last_seen within 24 hours
...
comment on function public.get_dashboard_stats() is
  'Dashboard stats; presence counts from online_users.last_seen (UTC).';
